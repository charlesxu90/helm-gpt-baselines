...
class SAScorer:
    def __init__(self, model_path='utils/sascore/SA_score_prediction.pkl.gz'):
    ...
    def get_scores(self, helms: List, valid_only=False):
        smiles = [get_cycpep_smi_from_helm(helm) for helm in helms]
